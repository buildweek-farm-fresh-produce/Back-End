...
router.get('/:id', (req, res) => {
    ...
    Consumers.findById(id)
        ...
        .catch(err => res.status(500).json({message: "We couldn't get the users at this time."}))
})
...
router.get('/:id/orders', (req, res) => {
    ...
    Consumers.ordersByCustomerId( id )
        ...
        .catch(err => res.status(500).json({message: "We couldn't get your orders at this time."}))
})
